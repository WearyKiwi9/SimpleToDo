package com.example.tpatel.simpletodo;
...
import static com.example.tpatel.simpletodo.MainActivity.ITEM_POSITION;
import static com.example.tpatel.simpletodo.MainActivity.ITEM_TEST;
...
public class EditItemActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etItemText.setText(getIntent().getStringExtra(ITEM_TEST));
    ...
    public void onSaveItem(View v){
        ...
        i.putExtra(ITEM_TEST, etItemText.getText().toString());
